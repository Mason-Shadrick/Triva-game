$(document).ready(function () {
  ...
  var triviaGame = [
    ...
    {
      question:
        "Shirley asks Abed to make a Christian movie telling the story of Jesus in season 2, What was the name of the movie he makes?",
      answer: [
        "Jesus: The Story of HIM",
        "The Newest New Testament",
        "Real Talk with the Lord",
        "ABED",
      ],
      correct: "3",
    },
  ...
  function loadQandA() {
    ...
    for (var i = 0; i < 4; i++) {
      ...
      $(".answers").append(
        "<h4 class = answersAll id=" + i + ">" + answer + "</h4></br>"
      );
  ...
  function timer() {
    if (timeRemain === 0) {
      ...
      $(".question").text(
        "The right answer is: " + triviaGame[indexQandA].answer[correct]
      );
      unAnswered();
      ...
      timeRemain--;
      $(".timeRemaining").text(
        "You have " + timeRemain + " seconds to choose!"
      );
    }
  }
  ...
  function resetRound() {
    ...
    if (indexQandA < triviaGame.length) {
      ...
      setTimeout(function () {
        ...
        $(".answerImage").remove();
        $(".answers").append(
          "<h4 class= answersAll end>CORRECT ANSWERS: " + correctAns + "</h4>"
        );
        $(".answers").append(
          "<h4 class= answersAll end>INCORRECT ANSWERS: " + wrongAns + "</h4>"
        );
        $(".answers").append(
          "<h4 class= answersAll end>UNANSWERED QUESTIONS: " +
            unAnsQuestions +
            "</h4>"
        );
        setTimeout(function () {
